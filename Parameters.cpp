...
const AP_Param::Info Plane::var_info[] = {
    ...
    // added by iwase 17/07/07

    // @Param: TPARAM_Control_Mode
    // @DisplayName: TPARAM_Control_Mode
    // @Description: TLab parameter, choice control mode
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_control_mode,    "TPARAM_C_mode",   0),

    // @Param: TPARAM_k
    // @DisplayName: TPARAM_k
    // @Description: TLab parameter, Proportionality constant
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_k,    "TPARAM_k",   0),

    // @Param: TPARAM_Va
    // @DisplayName: TPARAM_Va
    // @Description: TLab parameter, Air Speed
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_Va,    "TPARAM_Va",   0),

    // @Param: TPARAM_Vg_min
    // @DisplayName: TPARAM_Vg_min
    // @Description: TLab parameter, min ground speed
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_Vg_min,    "TPARAM_Vg_min",   0),

    // @Param: TPARAM_Vg_max
    // @DisplayName: TPARAM_Vg_max
    // @Description: TLab parameter, max ground speed
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_Vg_max,    "TPARAM_Vg_max",   0),

    // @Param: TPARAM_U_min
    // @DisplayName: TPARAM_U_min
    // @Description: TLab parameter, min controlbar angle
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_U_min,    "TPARAM_U_min",   0),

    // @Param: TPARAM_U_max
    // @DisplayName: TPARAM_U_max
    // @Description: TLab parameter, max controlbar angle
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_U_max,    "TPARAM_U_max",   0),

    // @Param: TPARAM_alpha_min
    // @DisplayName: TPARAM_alpha_min
    // @Description: TLab parameter, min sideslip angle
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_alpha_min,    "TPARAM_alpha_min",   0),

    // @Param: TPARAM_alpha_max
    // @DisplayName: TPARAM_alpha_max
    // @Description: TLab parameter, max sideslip angle
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_alpha_max,    "TPARAM_alpha_max",   0),

    // @Param: TPARAM_d1
    // @DisplayName: TPARAM_height_d1
    // @Description: TLab parameter, thrust coef 1
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_pdc_height_d1_Th,    "TPARAM_d1",   0),

    // @Param: TPARAM_d2
    // @DisplayName: TPARAM_height_d2
    // @Description: TLab parameter, thrust coef 2
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_pdc_height_d2_Th,    "TPARAM_d2",   0),

    // @Param: TPARAM_kp0
    // @DisplayName: TPARAM_height_kp0
    // @Description: TLab parameter, thrust Feedback gain 1
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_height_kp0_Th,    "TPARAM_kp0",   0),

    // @Param: TPARAM_kd0
    // @DisplayName: TPARAM_height_kd0
    // @Description: TLab parameter, thrust Feedback gain 2
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_height_kd0_Th,    "TPARAM_kd0",   0),

    // @Param: TPARAM_kp1
    // @DisplayName: TPARAM_height_kp1
    // @Description: TLab parameter, thrust Feedback gain 3
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_height_kp1_Th,    "TPARAM_kp1",   0),

    // @Param: TPARAM_kd1
    // @DisplayName: TPARAM_height_kd1
    // @Description: TLab parameter, thrust Feedback gain 4
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_height_kd1_Th,    "TPARAM_kd1",   0),

    // @Param: TPARAM_motor_neutral_Th
    // @DisplayName: TPARAM_motor_neutral_Th
    // @Description: TLab parameter, motor thrust neutral
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_motor_neutral_Th,    "TPARAM_m_trim_th",   0),

    // @Param: TPARAM_R
    // @DisplayName: TPARAM_R
    // @Description: TLab parameter, target circle radius
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_R,    "TPARAM_R",   0),

    // @Param: TPARAM_calc_GCRS
    // @DisplayName: TPARAM_calc_GCRS
    // @Description: TLab parameter, the way to calc ground course angle
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_calc_GCRS,    "TPARAM_calc_GCRS",   0),

    // @Param: TPARAM_center_lat
    // @DisplayName: TPARAM_center_lat
    // @Description: TLab parameter, target circle center lattitude
    // @Range: -900000000 900000000
    // @User: Advanced
    GSCALAR(TPARAM_center_lat,    "TPARAM_C_lat",   0),

    // @Param: TPARAM_center_lng
    // @DisplayName: TPARAM_center_lng
    // @Description: TLab parameter, target circle center lngitude
    // @Range: -1800000000 1800000000
    // @User: Advanced
    GSCALAR(TPARAM_center_lng,    "TPARAM_C_lng",   0),

    // @Param: TPARAM_r_min
    // @DisplayName: TPARAM_radius_min
    // @Description: TLab parameter, min radius
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_r_min,    "TPARAM_r_min",   0),

    // @Param: TPARAM_servo_neutral
    // @DisplayName: TPARAM_servo_neutral
    // @Description: TLab parameter, neutral of control bar
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_servo_neutral,    "TPARAM_s_neutral",   0),

    // @Param: TPARAM_F11
    // @DisplayName: TPARAM_F11
    // @Description: TLab parameter, feedback gain1
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_F11,    "TPARAM_F11",   0),

    // @Param: TPARAM_F12
    // @DisplayName: TPARAM_F12
    // @Description: TLab parameter, feedback gain2
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_F12,    "TPARAM_F12",   0),

    // @Param: TPARAM_F21
    // @DisplayName: TPARAM_F21
    // @Description: TLab parameter, feedback gain3
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_F21,    "TPARAM_F21",   0),

    // @Param: TPARAM_F22
    // @DisplayName: TPARAM_F22
    // @Description: TLab parameter, feedback gain4
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_F22,    "TPARAM_F22",   0),

    // @Param: TPARAM_F31
    // @DisplayName: TPARAM_F31
    // @Description: TLab parameter, feedback gain5
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_F31,    "TPARAM_F31",   0),

    // @Param: TPARAM_F32
    // @DisplayName: TPARAM_F32
    // @Description: TLab parameter, feedback gain6
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_F32,    "TPARAM_F32",   0),

    // @Param: TPARAM_F41
    // @DisplayName: TPARAM_F41
    // @Description: TLab parameter, feedback gain7
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_F41,    "TPARAM_F41",   0),

    // @Param: TPARAM_F42
    // @DisplayName: TPARAM_F42
    // @Description: TLab parameter, feedback gain8
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_F42,    "TPARAM_F42",   0),

    // @Param: TPARAM_rule_num
    // @DisplayName: TPARAM_rule_num
    // @Description: TLab parameter, number of fuzzy rules
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_rule_num,    "TPARAM_rule_num",   0),

    // @Param: TPARAM_Conbine
    // @DisplayName: TPARAM_Combine
    // @Description: TLab parameter, flag of use or not the Conbine Mode
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_Combine,    "TPARAM_Combine",   0),

    // @Param: TPARAM_change_y
    // @DisplayName: TPARAM_change_y
    // @Description: TLab parameter, value of y to change circle -> line trace
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_change_y,    "TPARAM_change_y",   0),

    // @Param: TPARAM_orbit_num
    // @DisplayName: TPARAM_orbit_num
    // @Description: TLab parameter, the number of orbiting in the circle
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_orbit_num,    "TPARAM_orbit",   0),

    // @Param: TPARAM_phi_max
    // @DisplayName: TPARAM_phi_max
    // @Description: TLab parameter, maximam value of yaw or ground course angle
    // @Range: -1000 1000
    // @User: Advanced
    GSCALAR(TPARAM_phi_max,    "TPARAM_phi_max",   0),
    ...
    // @Range: -900000000 900000000
    // @User: Advanced
    GSCALAR(TPARAM_Path_Origin_lat,    "TP2D_O_Lat",   0),

    // @Param: TPARAM_Path_Origin_lng
    // @DisplayName: TPARAM_Path_Origin_lng
    // @Description: TLab parameter
    // @Range: -1800000000 1800000000
    // @User: Advanced
    GSCALAR(TPARAM_Path_Origin_lng,    "TP2D_O_Lng",   0),

    // @Param: TPARAM_Fx1
    // @DisplayName: TPARAM_Fx1
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fx1,    "TP2D_Fx1",   0),

    // @Param: TPARAM_Fx2
    // @DisplayName: TPARAM_Fx2
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fx2,    "TP2D_Fx2",   0),

    // @Param: TPARAM_Fx3
    // @DisplayName: TPARAM_Fx3
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fx3,    "TP2D_Fx3",   0),

    // @Param: TPARAM_Fchi1_1
    // @DisplayName: TPARAM_Fchi1_1
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi1_1,    "TP2D_Fchi11",   0),

    // @Param: TPARAM_Fchi1_2
    // @DisplayName: TPARAM_Fchi1_2
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi1_2,    "TP2D_Fchi12",   0),

    // @Param: TPARAM_Fchi1_3
    // @DisplayName: TPARAM_Fchi1_3
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi1_3,    "TP2D_Fchi13",   0),

    // @Param: TPARAM_Fchi2_1
    // @DisplayName: TPARAM_Fchi2_1
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi2_1,    "TP2D_Fchi21",   0),

    // @Param: TPARAM_Fchi2_2
    // @DisplayName: TPARAM_Fchi2_2
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi2_2,    "TP2D_Fchi22",   0),

    // @Param: TPARAM_Fchi2_3
    // @DisplayName: TPARAM_Fchi2_3
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi2_3,    "TP2D_Fchi23",   0),

    // @Param: TPARAM_Fchi3_1
    // @DisplayName: TPARAM_Fchi3_1
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi3_1,    "TP2D_Fchi31",   0),

    // @Param: TPARAM_Fchi3_2
    // @DisplayName: TPARAM_Fchi3_2
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi3_2,    "TP2D_Fchi32",   0),

    // @Param: TPARAM_Fchi3_3
    // @DisplayName: TPARAM_Fchi3_3
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi3_3,    "TP2D_Fchi33",   0),

    // @Param: TPARAM_Fchi4_1
    // @DisplayName: TPARAM_Fchi4_1
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi4_1,    "TP2D_Fchi41",   0),

    // @Param: TPARAM_Fchi4_2
    // @DisplayName: TPARAM_Fchi4_2
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi4_2,    "TP2D_Fchi42",   0),

    // @Param: TPARAM_Fchi4_3
    // @DisplayName: TPARAM_Fchi4_3
    // @Description: TLab parameter
    // @Range: -100 100
    // @User: Advanced
    GSCALAR(TPARAM_Fchi4_3,    "TP2D_Fchi43",   0),

    // @Param: TPARAM_v_g_max
    // @DisplayName: TPARAM_v_g_max
    // @Description: TLab parameter
    // @Range: 0 100
    // @User: Advanced
    GSCALAR(TPARAM_v_g_max,    "TP2D_VgMax",   10.f),

    // @Param: TPARAM_v_g_min
    // @DisplayName: TPARAM_v_g_min
    // @Description: TLab parameter
    // @Range: 0 100
    // @User: Advanced
    GSCALAR(TPARAM_v_g_min,    "TP2D_VgMin",   3.f),

    // @Param: TPARAM_kappa_max
    // @DisplayName: TPARAM_kappa_max
    // @Description: TLab parameter
    // @Range: -10 10
    // @User: Advanced
    GSCALAR(TPARAM_kappa_max,    "TP2D_KappaMax",   0.1f),

    // @Param: TPARAM_kappa_min
    // @DisplayName: TPARAM_kappa_min
    // @Description: TLab parameter
    // @Range: -10 10
    // @User: Advanced
    GSCALAR(TPARAM_kappa_min,    "TP2D_KappaMin",   -0.1f),

    // @Param: TPARAM_u_x_max
    // @DisplayName: TPARAM_u_x_max
    // @Description: TLab parameter
    // @Range: 0 100
    // @User: Advanced
    GSCALAR(TPARAM_u_x_max,    "TP2D_UxMax",   7.f),

    // @Param: TPARAM_chiF_max_deg
    // @DisplayName: TPARAM_chiF_max_deg
    // @Description: TLab parameter
    // @Range: 0 180
    // @User: Advanced
