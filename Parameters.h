...
public:
    ...
    enum {
        ...
        // 256: TLAB Parameters
        k_param_TPARAM_control_mode,
        k_param_TPARAM_k,
        k_param_TPARAM_Va,
        k_param_TPARAM_Vg_min,
        k_param_TPARAM_Vg_max,
        k_param_TPARAM_U_min,
        k_param_TPARAM_U_max,
        k_param_TPARAM_alpha_min,
        k_param_TPARAM_alpha_max,
        k_param_TPARAM_pdc_height_d1_Th,
        k_param_TPARAM_pdc_height_d2_Th,
        k_param_TPARAM_height_kp0_Th,
        k_param_TPARAM_height_kd0_Th,
        k_param_TPARAM_height_kp1_Th,
        k_param_TPARAM_height_kd1_Th,
        k_param_TPARAM_motor_neutral_Th,
        k_param_TPARAM_R,
        k_param_TPARAM_calc_GCRS,
        k_param_TPARAM_center_lat,
        k_param_TPARAM_center_lng,
        k_param_TPARAM_r_min,
        k_param_TPARAM_servo_neutral,
        k_param_TPARAM_F11,
        k_param_TPARAM_F12,
        k_param_TPARAM_F21,
        k_param_TPARAM_F22,
        ...
        k_param_TPARAM_F41,
        k_param_TPARAM_F42,
        k_param_TPARAM_rule_num,
        k_param_TPARAM_Combine,
        k_param_TPARAM_change_y,
        k_param_TPARAM_orbit_num,
        k_param_TPARAM_phi_max,
        k_param_TPARAM_alternate,
        k_param_TPARAM_theta_a,
        k_param_TPARAM_V_a,
        k_param_TPARAM_cha_pow,
        k_param_TPARAM_MAX_slo,
        k_param_TPARAM_neutral_t,
        k_param_TPARAM_switch_mo,
        k_param_TPARAM_control_p,
        ...
        k_param_TPARAM_c_alt,

        // Added by Kaito Yamamoto 2021.07.12.
        k_param_TPARAM_v_a,
        k_param_TPARAM_k_prop_const,
        ...
        k_param_TPARAM_Fx2,
        k_param_TPARAM_Fx3,
        k_param_TPARAM_Fchi1_1,
        k_param_TPARAM_Fchi1_2,
        k_param_TPARAM_Fchi1_3,
        k_param_TPARAM_Fchi2_1,
        k_param_TPARAM_Fchi2_2,
        k_param_TPARAM_Fchi2_3,
        k_param_TPARAM_Fchi3_1,
        k_param_TPARAM_Fchi3_2,
        k_param_TPARAM_Fchi3_3,
        k_param_TPARAM_Fchi4_1,
        k_param_TPARAM_Fchi4_2,
        k_param_TPARAM_Fchi4_3,
        k_param_TPARAM_v_g_max,
        k_param_TPARAM_v_g_min,
        k_param_TPARAM_kappa_max,
        ...
        k_param_TPARAM_Bar_Control_Mode,  // Added by Kaito Yamamoto 2021.08.15.
    };
    ...
    AP_Int8 TPARAM_control_mode;
    AP_Float TPARAM_k;
    AP_Float TPARAM_Va;
    AP_Float TPARAM_Vg_min;
    AP_Float TPARAM_Vg_max;
    AP_Float TPARAM_U_min;
    AP_Float TPARAM_U_max;
    AP_Float TPARAM_alpha_min;
    AP_Float TPARAM_alpha_max;
    AP_Float TPARAM_pdc_height_d1_Th;
    AP_Float TPARAM_pdc_height_d2_Th;
    AP_Float TPARAM_height_kp0_Th;
    AP_Float TPARAM_height_kd0_Th;
    AP_Float TPARAM_height_kp1_Th;
    AP_Float TPARAM_height_kd1_Th;
    AP_Float TPARAM_motor_neutral_Th;
    AP_Float TPARAM_R;
    AP_Int8 TPARAM_calc_GCRS;
    AP_Int32 TPARAM_center_lat;
    AP_Int32 TPARAM_center_lng;
    AP_Float TPARAM_r_min;
    AP_Float TPARAM_servo_neutral;
    AP_Float TPARAM_F11;
    AP_Float TPARAM_F12;
    AP_Float TPARAM_F21;
    AP_Float TPARAM_F22;
    ...
    AP_Float TPARAM_F41;
    AP_Float TPARAM_F42;
    AP_Int8 TPARAM_rule_num;
    AP_Int8 TPARAM_Combine;
    AP_Float TPARAM_change_y;
    AP_Float TPARAM_orbit_num;
    AP_Float TPARAM_phi_max;
    AP_Int8 TPARAM_alternate;
    AP_Float TPARAM_theta_a;
    AP_Float TPARAM_V_a;
    AP_Int32 TPARAM_cha_pow;
    AP_Int32 TPARAM_MAX_slo;
    AP_Int32 TPARAM_neutral_t;
    AP_Int32 TPARAM_switch_mo;
    AP_Float TPARAM_control_a;
    ...
    AP_Int8 TPARAM_c_alt;

    // Added by Kaito Yamamoto 2021.07.12.
    AP_Float TPARAM_v_a;
    AP_Float TPARAM_k_prop_const;  // Added by Kaito Yamamoto 2021.08.06.
    ...
    AP_Float TPARAM_Fx2;
    AP_Float TPARAM_Fx3;
    AP_Float TPARAM_Fchi1_1;
    AP_Float TPARAM_Fchi1_2;
    AP_Float TPARAM_Fchi1_3;
    AP_Float TPARAM_Fchi2_1;
    AP_Float TPARAM_Fchi2_2;
    AP_Float TPARAM_Fchi2_3;
    AP_Float TPARAM_Fchi3_1;
    AP_Float TPARAM_Fchi3_2;
    AP_Float TPARAM_Fchi3_3;
    AP_Float TPARAM_Fchi4_1;
    AP_Float TPARAM_Fchi4_2;
    AP_Float TPARAM_Fchi4_3;
    AP_Float TPARAM_v_g_max;
    AP_Float TPARAM_v_g_min;
    AP_Float TPARAM_kappa_max;
    ...
    AP_Int8  TPARAM_Bar_Control_Mode;  // Kaito Yamamoto 2021.08.15.
